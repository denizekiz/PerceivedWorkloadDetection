...
model.add(Conv2D(filters=15, kernel_size=(3,2),activation='relu'))
model.add(Conv2D(filters=15, kernel_size=(3,1),activation='relu'))
model.add(MaxPooling2D(pool_size=(2,1)))
model.add(Conv2D(filters=25, kernel_size=(4,1),activation='relu'))
model.add(Conv2D(filters=25, kernel_size=(4,1),activation='relu'))
model.add(Conv2D(filters=25, kernel_size=(4,1),activation='relu'))
model.add(MaxPooling2D(pool_size=(2,1)))
model.add(Conv2D(filters=40, kernel_size=(2,1),activation='relu'))
model.add(Conv2D(filters=40, kernel_size=(2,1),activation='relu'))
model.add(Conv2D(filters=40, kernel_size=(2,1),activation='relu'))
model.add(Flatten())
